...
<p>Inizialmente, non avevamo completato in tempo la fase di “build automation”, a causa principalmente dell’inesperienza 
...
ha una gestione complessiva più semplice, anche in fase di portabilità, che ci ha permesso, appunto, di raggiungere l’obiettivo.</p>

## Apache Ant

<p>Apache Ant è un software per l'automazione del processo di build. È simile a make, ma scritto in Java ed è principalmente orientato
...
nel nostro “build.xml” sono:p align="center">
<br>
...
- Visualization for models with more than 2 featurests
